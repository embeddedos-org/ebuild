...
SOURCE_REPOS = {
    ...
    "ebuild":  {"dirs": ["ebuild","examples"],
        ...
        "EoSuite": {"dirs": ["src","include","gui","tests"],
...
def package_deliverable(target, version="0.2.0", build_dir="build",
    ...
    manifest = {
        ...
        "components": {"eos":"0.5.0","eboot":"0.3.0","eai":"0.2.0",
                       "eni":"0.2.0","eipc":"0.2.0","eosuite":"0.2.0"},
    ...
    with open(os.path.join(out,"docs","README.md"),"w") as f:
        ...
        f.write("| eosuite/ | EoSuite binaries + config |\n")
