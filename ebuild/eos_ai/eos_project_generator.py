...
class EosProjectGenerator:
    ...
    EOS_BOARD_MAP: Dict[str, str] = {
        ...
        # --- ARM Cortex-M ---
        "stm32f0": "generic-cortex-m0.yaml",
        "stm32l0": "generic-cortex-m0plus.yaml",
        "stm32f1": "generic-cortex-m3.yaml",
        "lpc55": "generic-cortex-m23.yaml",
        "stm32l5": "generic-cortex-m33.yaml",
        "corstone": "generic-cortex-m55.yaml",
        "ra8": "generic-cortex-m85.yaml",
        # --- ARM Cortex-R/A ---
        "rm46": "generic-cortex-r4.yaml",
        "cortex_r52": "generic-cortex-r52.yaml",
        "sama5": "generic-cortex-a5.yaml",
        "zynq": "generic-cortex-a9.yaml",
        "omap5": "generic-cortex-a15.yaml",
        "imx8x": "generic-cortex-a35.yaml",
        "rk3568": "generic-cortex-a55.yaml",
        "rk3588": "generic-cortex-a76.yaml",
        # --- Legacy ARM ---
        "lpc21": "generic-arm7tdmi.yaml",
        "at91": "generic-arm9.yaml",
        "bcm2835": "generic-arm11.yaml",
        # --- Microchip ---
        "atmega": "generic-avr.yaml",
        "attiny": "generic-avr.yaml",
        "at32uc3": "generic-avr32.yaml",
        "pic16": "generic-pic16.yaml",
        "pic18": "generic-pic18.yaml",
        "pic24": "generic-pic24.yaml",
        "dspic": "generic-dspic.yaml",
        "pic32m": "generic-pic32.yaml",
        # --- TI ---
        "msp430": "generic-msp430.yaml",
        "tms320f28": "generic-c28x.yaml",
        "tms320c6": "generic-c6000.yaml",
        "pru": "generic-pru.yaml",
        # --- Renesas + Infineon ---
        "rl78": "generic-rl78.yaml",
        "rx65": "generic-rx.yaml",
        "rx72": "generic-rx.yaml",
        "tc3": "generic-tricore.yaml",
        "xc22": "generic-c166.yaml",
        # --- FPGA ---
        "microblaze": "generic-microblaze.yaml",
        "nios": "generic-nios2.yaml",
        "mor1kx": "generic-openrisc.yaml",
        "lm32": "generic-lm32.yaml",
        # --- DSP ---
        "adsp_bf": "generic-blackfin.yaml",
        "adsp_21": "generic-sharc.yaml",
        "hexagon": "generic-hexagon.yaml",
        "ceva": "generic-ceva.yaml",
        "hifi": "generic-xtensa-hifi.yaml",
        # --- Misc ---
        "arc": "generic-arc.yaml",
        "stc89": "generic-8051.yaml",
        "efm8": "generic-8051.yaml",
        "riscv32": "generic-riscv32.yaml",
        "esp32s3": "generic-esp32s3.yaml",
        "esp32c3": "generic-esp32c3.yaml",
        # --- Server/exotic ---
        "mips64": "generic-mips64.yaml",
        "sparc64": "generic-sparc64.yaml",
        "ppc64": "generic-ppc64.yaml",
        "power": "generic-ppc64.yaml",
        "loong": "generic-loongarch.yaml",
        "pa87": "generic-parisc.yaml",
        "itanium": "generic-ia64.yaml",
        "alpha": "generic-alpha.yaml",
        "s390": "generic-s390.yaml",
        "ibm_z": "generic-s390.yaml",
        "etrax": "generic-cris.yaml",
        "csr86": "generic-kalimba.yaml",
        "kalimba": "generic-kalimba.yaml",
    }
    ...
    ARCH_TO_TOOLCHAIN: Dict[str, str] = {
        ...
        # --- New architecture toolchains ---
        "avr": "avr-gcc.yaml",
        "avr32": "avr32-gcc.yaml",
        "pic16": "xc8.yaml",
        "pic18": "xc8.yaml",
        "pic24": "xc16.yaml",
        "dspic": "xc16.yaml",
        "pic32": "xc32.yaml",
        "msp430": "msp430-elf-gcc.yaml",
        "c28x": "ti-cgt-c2000.yaml",
        "c6000": "ti-cgt-c6000.yaml",
        "pru": "ti-cgt-pru.yaml",
        "rl78": "rl78-elf-gcc.yaml",
        "rx": "rx-elf-gcc.yaml",
        "tricore": "tricore-elf-gcc.yaml",
        "c166": "c166-elf-gcc.yaml",
        "microblaze": "microblaze-elf-gcc.yaml",
        "nios2": "nios2-elf-gcc.yaml",
        "openrisc": "or1k-elf-gcc.yaml",
        "lm32": "lm32-elf-gcc.yaml",
        "blackfin": "bfin-elf-gcc.yaml",
        "sharc": "sharc-elf-gcc.yaml",
        "hexagon": "hexagon-clang.yaml",
        "ceva": "ceva-toolchain.yaml",
        "xtensa-hifi": "xt-clang.yaml",
        "arc": "arc-elf-gcc.yaml",
        "8051": "sdcc.yaml",
        "loongarch": "loongarch64-linux-gnu-gcc.yaml",
        "parisc": "hppa-linux-gnu-gcc.yaml",
        "ia64": "ia64-linux-gnu-gcc.yaml",
        "alpha": "alpha-linux-gnu-gcc.yaml",
        "s390": "s390x-linux-gnu-gcc.yaml",
        "cris": "cris-linux-gnu-gcc.yaml",
        "kalimba": "kalimba-toolchain.yaml",
        "ppc64": "powerpc64-linux-gnu-gcc.yaml",
    }
